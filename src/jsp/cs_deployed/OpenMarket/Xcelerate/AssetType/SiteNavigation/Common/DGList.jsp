...
<asset:list list="SPList" type="SiteNavigation" excludevoided="true" pubid='<%=ics.GetVar("pubid")%>' />
...
<ics:then>
	...
	<td class="form-inset" align="left" style="width: 230px;">
	<%
	...
	<td class="form-label-text" align="right" VALIGN="TOP" NOWRAP="true" style="width:200px;margin-left:196px;">
		<xlat:stream key="fatwire/admin/mobility/AssociatedDeviceGroups"/>:
	</td>
	<td class="form-inset" align="right" style="width: 120px;float:left;">
	<%
		deviceGroupList = ics.GetList("DGList");
		if("new".equals(ics.GetVar("formtype")))
		{
