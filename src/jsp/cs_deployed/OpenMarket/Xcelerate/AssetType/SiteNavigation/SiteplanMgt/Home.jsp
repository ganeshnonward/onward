...
<ics:setvar name="AssetType" value="SiteNavigation" />
	...
	<tr>
		...
		<td >
			<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" >
				<tr>
					<td colspan="13" class="tile-highlight"  onmouseout="window.status='';return true">
						<IMG WIDTH="1" HEIGHT="1" src='<%=ics.GetVar("cs_imagedir") + "/graphics/common/screen/dotclear.gif"%>'/>
					</td>
				</tr>
				<tr>
					...
					<%-- Icon header --%>
					<td class="tile-b" background='<%=ics.GetVar("cs_imagedir") + "/graphics/common/screen/grad.gif"%>'>&nbsp;</td>
					<td class="tile-b" background='<%=ics.GetVar("cs_imagedir") + "/graphics/common/screen/grad.gif"%>' align='center'>
						<DIV class="new-table-title"><xlat:stream key="fatwire/Admin/SiteNavigationIcon" />&nbsp;</DIV>
					</td>
					<td class="tile-b" background='<%=ics.GetVar("cs_imagedir") + "/graphics/common/screen/grad.gif"%>'>&nbsp;</td>
				...
				<ics:then>																
					<ics:listloop listname="SitePlanList">
						...
						<tr class='<%=ics.GetVar("rowStyle") %>' id='SitePlanList.id' name="deviceGroupRow" REPLACEALL='SitePlanList.id'>
							...
							<td></td>
							<td align='center'>
								<ics:listget listname="SitePlanList" fieldname="urliconimage" output="_urliconimage_file"/>
								<ics:if condition='<%=Utilities.goodString(ics.GetVar("_urliconimage_file")) %>'>
								<ics:then>
									<render:getbloburl outstr="imageUrl" c="SiteNavigation" cid='<%=ics.GetVar("_id") %>' field="urliconimage" />
									<img height="16" width="16" src='<%= ics.GetVar("imageUrl") %>' border="0" />&nbsp;
								</ics:then>
								 </ics:if>
							</td>
							<td></td>
