...
<asset:load name="deleteSiteplanAsset" type="SiteNavigation" field="id" value='<%=ics.GetVar("spid")%>' editable="true"/>

<asset:load name="spAsset" type="SiteNavigation" objectid='<%=ics.GetVar("spid") %>' />
