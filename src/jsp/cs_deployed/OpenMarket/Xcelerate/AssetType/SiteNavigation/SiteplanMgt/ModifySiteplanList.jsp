...
<ics:then>
	...
	<asset:search type="SiteNavigation" prefix="prefix" list="siteplanlist"/>
...
<ics:then>
	<div class="width-outer-70"> 
		<ics:callelement element="OpenMarket/Xcelerate/UIFramework/Util/ShowMessage">
			<ics:argument name="msgtext" value="SiteNavigation name does not match"/>
...
<ics:else>
	...
	<ics:then>
		<asset:list list="siteplanlist" type="SiteNavigation" excludevoided="true" pubid='<%=ics.GetVar("pubid")%>' order="name, description desc"/>
		<ics:if condition='<%=null != ics.GetList("siteplanlist") && ics.GetList("siteplanlist").hasData()%>'>
		<ics:then>
			<ics:setvar name="isSearchListAvailable" value="true" />
		</ics:then>
	...
	<ics:then>
		<table class="width-outer-70" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<td>
					<span class="title-text">Modify SiteNavigation</span>
				</td>
			</tr>
		...
		<table class="width-outer-70" bgcolor="#FFFFFF" BORDER="0" CELLPADDING="0" CELLSPACING="0">
        	...
        	<tr>
        		<td  class="form-label-inset"  nowrap="true" colspan="2">
					Select the SiteNavigation to modify
				</td>
        	</tr>
        	<tr>
				<td>
