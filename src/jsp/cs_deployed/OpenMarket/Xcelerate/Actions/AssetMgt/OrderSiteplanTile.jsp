				...
				<ics:then>
					<ics:listloop listname="SitePlanList">
						...
						<tr class='<%=ics.GetVar("rowStyle")%> dojoDndItem' id='<%="Rank-" + ics.GetVar("sid")%>' name="siteplanrow">
							<td><BR /></td>
							<td><BR /></td>
							<ics:sql sql='<%="select nrank from SitePlanTree where otype=\'SiteNavigation\' and oid=\'" + ics.GetVar("sid") + "\'"%>' listname="slist" table="SitePlanTree" />
...
<div class="width-outer-70">
	<div style="display:none" id="reorderdiv">
