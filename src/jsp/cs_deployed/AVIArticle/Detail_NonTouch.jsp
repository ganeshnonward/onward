...
<cs:ftcs>
	...
	<div class="article-detail">
		<h4 class="section-title">
			<fragment:include name="articleCategoryLinkNonTouch"/>
		</h4>
		
		<div class="article">
			<fragment:include name="articleRelatedImageSummaryNonTouch"/>
			...
			<c:choose>
				<c:when test="${not empty parentPageId}">
					...
					<c:forEach begin="0" end="${articleLinkNonTouch.size()-1}" var="status">
						<div class="innerArticleDiv">
							<div class="text">
								<fragment:include name="articleLinkNonTouch" index="${status}"/>
							</div>
							<div class="icon"></div>
						</div>
					</c:forEach>
