...
%>
	...
	<div data-dojo-type="dojox.data.QueryReadStore" jsId="${tree.id}Store" url="${tree.datastoreUrl}" requestMethod="post"></div>

	<!-- fetch all immediate children  -->
	<div data-dojo-type="fw.ui.data.stores.CSForestStoreModel" 
	...
	<div data-dojo-type="fw.dijit.UITree" 
 		 id="${tree.id}"
